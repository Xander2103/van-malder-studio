...
return [
    ...
    [
        ...
        'locale'           => 'nl',
        'meta_title'       => 'Website laten maken Tervuren | Van Malder Studio',
        ...
        'intro'            => 'Als developer uit de Druivenstreek ken ik de lokale markt. Of je nu een tuinarchitect bent in Tervuren, een kinesist in Vossem, een aannemer in Moorsel of een horecazaak in de buurt — ik bouw een website die past bij jouw zaak en jouw klanten. Korte communicatielijnen, persoonlijk contact en een resultaat dat je iets oplevert.',
        'service_type'     => 'website',
        ...
        'bullets'          => [
            ...
            'Lokale kennis van Tervuren en de Druivenstreek',
        ...
        'steps'            => [
            ['title' => 'Kennismakingsgesprek', 'body' => 'We bespreken jouw zaak, jouw klanten en wat je van je website verwacht. In de buurt of via video.'],
        ...
        'faq'              => [
            ...
            ['q' => 'Kunnen we elkaar ontmoeten?', 'a' => 'Ja, dat is zeker mogelijk. Een kennismakingsgesprek in de buurt of via video — jij kiest wat het beste uitkomt.'],
            ['q' => 'Wat kost een website voor een kleine lokale zaak?', 'a' => 'Een eenvoudige professionele website begint vanaf €750. Prijs hangt af van het aantal pagina\'s, gewenste functies en inhoud. Na een gesprek maak ik een voorstel op maat.'],
        ],
